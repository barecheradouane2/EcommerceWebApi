...
namespace EcommerceWeb.Api.Migrations
{
    ...
    [Migration("20250419105149_adding wilaya and shippin g")]
    partial class addingwilayaandshipping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceWeb.Api.Models.Domain.Orders", b =>
                {
                    b.HasOne("EcommerceWeb.Api.Models.Domain.Commune", "Commune")
                        .WithMany()
            ...
            modelBuilder.Entity("EcommerceWeb.Api.Models.Domain.ShippingInfo", b =>
                {
                    b.HasOne("EcommerceWeb.Api.Models.Domain.Wilaya", "Wilaya")
                        ...
                        .HasForeignKey("EcommerceWeb.Api.Models.Domain.ShippingInfo", "WilayaID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
