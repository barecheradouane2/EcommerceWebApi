...
namespace EcommerceWeb.Api.Migrations
{
    ...
    [Migration("20241207153604_FixProductImagesForeignKey")]
    partial class FixProductImagesForeignKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EcommerceWeb.Api.Models.Domain.Commune", b =>
                {
                    ...
                    b.Property<string>("WilayaID")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("WilayaID1")
                        .HasColumnType("int");

                    b.HasKey("CommuneID");

                    b.HasIndex("WilayaID1");
